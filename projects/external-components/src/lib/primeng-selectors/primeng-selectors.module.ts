import { SnakeGameComponent } from './components/Snake-game--external/Snake-game--external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, SnakeGameComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, SnakeGameComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
