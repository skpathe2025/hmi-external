import { TrackBabyVaccinationComponent } from './components/Track-baby-vaccination-external/Track-baby-vaccination-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, TrackBabyVaccinationComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, TrackBabyVaccinationComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
