import { RecipeSaverComponent } from './components/Recipe-Saver-external/Recipe-Saver-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, RecipeSaverComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, RecipeSaverComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
