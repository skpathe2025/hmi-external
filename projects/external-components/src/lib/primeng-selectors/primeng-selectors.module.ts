import { SudukuComponent } from './components/Suduku-external/Suduku-external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, SudukuComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, SudukuComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
